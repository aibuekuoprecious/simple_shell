...
/**
 * _myenv -  lists all environment variables and their values
...
/**
 * _mysetenv - sets the value of a new
 * or existing environment variable
 * @info: Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 *
 *  Return: Always 0
...
/**
 * populate_env_list - creates a linked list
 ...
 * Return: Always 0
 */
int populate_env_list(data *info)
{
